...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void HandGrabUseInteractable_Reset_m1DC320B34677CF8499F1D3340E153A34F0B679FE (HandGrabUseInteractable_t7B18FA843065BC0F35943FF6E2908976DC55A1E4* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->____relaxedHandGrabPoses_25 = L_5;
		Il2CppCodeGenWriteBarrier((void**)(&__this->____relaxedHandGrabPoses_25), (void*)L_5);
	}
...
{
	{
		...
		bool* L_1 = (&((Interactor_2_t97A56A173D43E0EDF08F050226C6432B3D9F7E8B*)__this)->____started_30);
...
IL_0015:
	{
		...
		SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C** L_2 = (&__this->____fingerUseStrength_42);
		float L_3;
		...
		__this->____handUseShouldUnselect_45 = (bool)((((int32_t)L_8) == ((int32_t)0))? 1 : 0);
		// if (_usesHandPose && !_handUseShouldUnselect)
		bool L_9 = __this->____usesHandPose_43;
		if (!L_9)
		{
			goto IL_0061;
		}
	...
	{
		bool L_10 = __this->____handUseShouldUnselect_45;
		if (L_10)
		{
			goto IL_0061;
		}
	}
	{
		...
		SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C** L_11 = (&__this->____fingerUseStrength_42);
		float L_12 = V_1;
...
IL_0044_1:
			{
				HandPose_t0B0F57FC79F74C9D20E54C6999A45D59FDDAC733** L_11 = (&__this->____cachedRelaxedHandPose_39);
				HandPose_t0B0F57FC79F74C9D20E54C6999A45D59FDDAC733** L_12 = (&__this->____cachedTightHandPose_40);
				NullCheck(G_B5_1);
				bool L_13;
			...
			}
			{
				...
				HandPose_t0B0F57FC79F74C9D20E54C6999A45D59FDDAC733* L_18 = __this->____relaxedHandPose_37;
				HandPose_t0B0F57FC79F74C9D20E54C6999A45D59FDDAC733* L_19 = __this->____cachedRelaxedHandPose_39;
				NullCheck(L_18);
				...
				HandPose_t0B0F57FC79F74C9D20E54C6999A45D59FDDAC733* L_20 = __this->____tightHandPose_38;
				HandPose_t0B0F57FC79F74C9D20E54C6999A45D59FDDAC733* L_21 = __this->____cachedTightHandPose_40;
				NullCheck(L_20);
